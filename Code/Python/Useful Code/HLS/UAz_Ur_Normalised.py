...
ax10.plot(time*rate[3]+0.275, U_r_Peak[3,:], label = '3RPM')
ax10.plot(time*rate[4], U_r_Peak[4,:], label = '6RPM')
ax10.plot(time*rate[5]-0.124, U_r_Peak[5,:], label = '9RPM')
ax10.plot(time*rate[6]-0.221, U_r_Peak[6,:], label = '12RPM')
ax10.legend()
...
ax11.plot(time*rate[3]+0.314, U_az_Peak[3,:], label = '3RPM')
ax11.plot(time*rate[4], U_az_Peak[4,:], label = '6RPM')
ax11.plot(time*rate[5]-0.159, U_az_Peak[5,:], label = '9RPM')
