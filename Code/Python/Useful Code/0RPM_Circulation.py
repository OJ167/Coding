...
ax2.plot(time, sumVorticity5050,    label = "stroke: 50  Speed 50 " )
ax2.plot(time, sumVorticity50100,   label = "stroke: 50  Speed 100" )
ax2.plot(time, sumVorticity10050,   label = "stroke: 100 Speed 50 " )
ax2.plot(time, sumVorticity100100,  label = "stroke: 100 Speed 100" )
