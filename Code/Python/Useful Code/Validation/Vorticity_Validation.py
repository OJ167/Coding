...
def path_integral_Tan_velocity(
    ...
    sumpath1 = sum(abs(u[24, 24:76]))
    sumpath2 = sum(abs(v[24:76, 76]))
    sumpath3 = sum(abs(u[76, 76:24]))
    sumpath4 = sum(abs(v[76:24, 24]))
