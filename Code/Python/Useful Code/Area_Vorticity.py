...
# ax8.plot(r_nd, u0mean[82, :, 18], label = "0 Seconds")
# ax8.plot(r_nd, u0mean[170, :, 18], label = "1 Second")
# ax8.plot(r_nd, u0mean[260, :, 18], label = "2 Seconds")
# ax8.plot(r_nd, u0mean[350, :, 18], label = "3 Seconds")
# ax8.plot(r_nd, u0mean[440, :, 18], label = "4 Seconds")
# ax8.plot(r_nd, u0mean[530, :, 18], label = "5 Seconds")
# plt.legend()
