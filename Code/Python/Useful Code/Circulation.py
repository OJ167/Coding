...
# f13, ax16 = plt.subplots(nrows=1, ncols=1)
# plt.title("50/100 - Time of Peak Circulation Against Rotation Rate")
# # ax16.plot(time, sumVorticity0 [normmaxloc0] , label = "0 RPM")
# ax16.scatter(1 , sumVorticity1 [int(normmaxloc1)] , label = "1 RPM")
# ax16.scatter(2 , sumVorticity2 [int(normmaxloc2)] , label = "2 RPM")
# ax16.scatter(3 , sumVorticity3 [int(normmaxloc3)] , label = "3 RPM")
# ax16.scatter(6 , sumVorticity6 [int(normmaxloc6)] , label = "6 RPM")
# ax16.scatter(9 , sumVorticity9 [int(normmaxloc9)] , label = "9 RPM")
# ax16.scatter(12, sumVorticity12[int(normmaxloc12)], label = "12 RPM")
# ax16.set_xlabel("Rotation Rate [RPM]")
# ax16.set_ylabel("Peak time")
# plt.legend()

# f13, ax16 = plt.subplots(nrows=1, ncols=1)
# plt.title("50/100 - Time of Peak Circulation Against Rossby")
# # ax16.plot(time, sumVorticity0 [normmaxloc0] , label = "0 RPM")
# ax16.scatter(4.7755, maxloc1 , label = "1 RPM")
# ax16.scatter(2.3877, maxloc2 , label = "2 RPM")
# ax16.scatter(1.5913, maxloc3 , label = "3 RPM")
# ax16.scatter(0.7957, maxloc6 , label = "6 RPM")
# ax16.scatter(0.5305, maxloc9 , label = "9 RPM")
# ax16.scatter(0.3980, maxloc12 label = "12 RPM")
# ax16.set_xlabel("Ro")
# ax16.set_ylabel("Peak time")
# plt.legend()
...
# plt.title("50/100 - Time of Peak Circulation Against Rossby")
# # ax16.plot(time, sumVorticity0 [normmaxloc0] , label = "0 RPM")
# ax16.scatter(4.7755, sumVorticity1 [int(normmaxloc1)] , label = "1 RPM")
# ax16.scatter(2.3877, sumVorticity2 [int(normmaxloc2)] , label = "2 RPM")
# ax16.scatter(1.5913, sumVorticity3 [int(normmaxloc3)] , label = "3 RPM")
# ax16.scatter(0.7957, sumVorticity6 [int(normmaxloc6)] , label = "6 RPM")
# ax16.scatter(0.5305, sumVorticity9 [int(normmaxloc9)] , label = "9 RPM")
# ax16.scatter(0.3980, sumVorticity12[int(normmaxloc12)], label = "12 RPM")
# ax16.invert_xaxis()
# ax16.set_xlabel("Ro")
# ax16.set_ylabel("Peak time")
# plt.legend()
...
f13, ax16 = plt.subplots(nrows=1, ncols=1)
plt.title("50/50 - Time of Peak Circulation Against Rotation Rate")
# ax16.plot(time, sumVorticity0 [normmaxloc0] , label = "0 RPM")
ax16.scatter(1 , sumVorticity1 [int(normmaxloc1)] , label = "1 RPM")
ax16.scatter(2 , sumVorticity2 [int(normmaxloc2)] , label = "2 RPM")
ax16.scatter(3 , sumVorticity3 [int(normmaxloc3)] , label = "3 RPM")
...
f13, ax16 = plt.subplots(nrows=1, ncols=1)
plt.title("50/50 - Time of Peak Circulation Against Rossby")
# ax16.plot(time, sumVorticity0 [normmaxloc0] , label = "0 RPM")
ax16.scatter((4.7755*2), (normmaxloc1) , label = "1 RPM")
ax16.scatter((2.3877*2), (normmaxloc2) , label = "2 RPM")
ax16.scatter((1.5913*2), (normmaxloc3) , label = "3 RPM")
ax16.scatter((0.7957*2), (normmaxloc6) , label = "6 RPM")
ax16.scatter((0.5305*2), (normmaxloc9) , label = "9 RPM")
ax16.scatter((0.3980*2), (normmaxloc12), label = "12 RPM")
ax16.set_xlabel("Ro")
ax16.set_ylabel("Peak time")
plt.legend()
...
plt.title("50/50 - Time of Peak Circulation Against Rossby")
# ax16.plot(time, sumVorticity0 [normmaxloc0] , label = "0 RPM")
ax16.scatter((4.7755*2), sumVorticity1 [int(normmaxloc1)] , label = "1 RPM")
ax16.scatter((2.3877*2), sumVorticity2 [int(normmaxloc2)] , label = "2 RPM")
ax16.scatter((1.5913*2), sumVorticity3 [int(normmaxloc3)] , label = "3 RPM")
ax16.scatter((0.7957*2), sumVorticity6 [int(normmaxloc6)] , label = "6 RPM")
ax16.scatter((0.5305*2), sumVorticity9 [int(normmaxloc9)] , label = "9 RPM")
ax16.scatter((0.3980*2), sumVorticity12[int(normmaxloc12)], label = "12 RPM")
ax16.set_xlabel("Ro")
ax16.set_ylabel("Peak time")
plt.legend()
